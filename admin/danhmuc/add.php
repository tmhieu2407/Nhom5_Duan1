    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control text-left" id="maloai" name="id_danhmuc" placeholder="Nhập vào mã loại">
        </div>
        <div class="mb-3">
          <label for="tenloai" class="text-right">Tên loại</label>
          <input type="text" class="form-control text-left" id="tenloai" name="tendanhmuc" placeholder="Nhập vào tên"
            required>
        </div>
        <div class="mb-3">
